...
import { THEME_NAMES } from '../assets/themes';
import { Send } from 'lucide-react';


const PREVIEW_MESSAGES = [
  { id: 1, content: 'Hello, how are you?', isSent: false },
  { id: 2, content: 'Are you coming to the party?', isSent: true },
];
        ...
        <div className='space-y-6'>
          ...
          <div className='grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2'>
            {THEME_NAMES.map((themeName) => (
              <button
                key={themeName}
                className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg transition-colors ${theme === themeName ? 'bg-base-200' : 'hover:bg-base-200/50'}`}
